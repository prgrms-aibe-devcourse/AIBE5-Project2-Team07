        ...
        <div className="max-w-4xl mx-auto flex items-center gap-6">
          ...
          <div className="flex-1 flex gap-3">
            <CommonButton
              ...
              disabled={!isOpenStatus || isOwnRecruit || chatStarting}
              onClick={handleChatClick}
              className={`flex-1 rounded-xl ${isOpenStatus && !isOwnRecruit ? 'bg-surface-container hover:bg-surface-variant' : 'bg-gray-200 text-gray-500 cursor-not-allowed'}`}
            >
              {chatStarting ? '채팅창 여는 중...' : isOwnRecruit ? '내 공고입니다' : '채팅하기'}
            </CommonButton>
            <CommonButton
