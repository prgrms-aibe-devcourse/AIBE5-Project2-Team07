          ...
          <div className="custom-container">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-primary-soft rounded-xl p-7 flex flex-col justify-between min-h-[240px] transition-all shadow-md shadow-primary/5 hover:shadow-xl hover:-translate-y-1 relative">
                <div>
                  <span className="text-primary font-bold text-xs block mb-1">삼성동 마이카페</span>
                ...
                <div className="flex justify-between items-end mt-4">
                  <span className="text-xl font-black text-primary">16,000원<small className="text-[10px] font-bold text-on-surface ml-1">/시간</small></span>
              ...
              <div className="bg-primary-soft rounded-xl p-7 flex flex-col justify-between min-h-[240px] transition-all shadow-md shadow-primary/5 hover:shadow-xl hover:-translate-y-1 relative">
                <div>
                  <span className="text-primary font-bold text-xs block mb-1">판교 정보단지</span>
                  <h3 className="text-lg font-bold leading-snug mb-3 flex items-center gap-1">
                    <span className="material-symbols-outlined text-primary text-lg" style={{ fontVariationSettings: '"FILL" 1' }}>notifications_active</span>
                    행사 등록 데스크 안내 요원
                  </h3>
                ...
                <div className="flex justify-between items-end mt-4">
                  <span className="text-xl font-black text-primary">13,500원<small className="text-[10px] font-bold text-on-surface ml-1">/시간</small></span>
                  <button className="material-symbols-outlined text-on-surface-variant/40 hover:text-primary transition-colors">bookmark</button>
                </div>
                <Link to="/recruit-detail" className="absolute inset-0 z-10"></Link>
              </div>
              ...
              <div className="bg-primary-soft rounded-xl p-7 flex flex-col justify-between min-h-[240px] transition-all shadow-md shadow-primary/5 hover:shadow-xl hover:-translate-y-1 relative">
                <div>
                  <span className="text-primary font-bold text-xs block mb-1">더 플랜지</span>
                  <h3 className="text-lg font-bold leading-snug mb-3 flex items-center gap-1">
                    <span className="material-symbols-outlined text-primary text-lg" style={{ fontVariationSettings: '"FILL" 1' }}>notifications_active</span>
                    주방 설거지 및 뒷정리 보조
                  </h3>
                ...
                <div className="flex justify-between items-end mt-4">
                  <span className="text-xl font-black text-primary">15,000원<small className="text-[10px] font-bold text-on-surface ml-1">/시간</small></span>
                  <button className="material-symbols-outlined text-on-surface-variant/40 hover:text-primary transition-colors">bookmark</button>
                </div>
                <Link to="/recruit-detail" className="absolute inset-0 z-10"></Link>
              </div>
              ...
              <div className="bg-primary-soft rounded-xl p-7 flex flex-col justify-between min-h-[240px] transition-all shadow-md shadow-primary/5 hover:shadow-xl hover:-translate-y-1 relative">
                <div>
                  <span className="text-primary font-bold text-xs block mb-1">메디 스캔</span>
                  <h3 className="text-lg font-bold leading-snug mb-3 flex items-center gap-1">
                    <span className="material-symbols-outlined text-primary text-lg" style={{ fontVariationSettings: '"FILL" 1' }}>notifications_active</span>
                    검진 센터 문서 파쇄 단기 알바
                  </h3>
                ...
                <div className="flex justify-between items-end mt-4">
                  <span className="text-xl font-black text-primary">12,000원<small className="text-[10px] font-bold text-on-surface ml-1">/시간</small></span>
                  <button className="material-symbols-outlined text-on-surface-variant/40 hover:text-primary transition-colors">bookmark</button>
                </div>
                <Link to="/recruit-detail" className="absolute inset-0 z-10"></Link>
              </div>
          ...
          <div className="custom-container">
            <div className="mb-12">
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex gap-2 bg-outline/20 p-1 rounded-lg">
                  <button className="px-4 py-1.5 bg-white text-on-surface rounded-md text-sm font-bold shadow-sm">최신순</button>
                  <button className="px-4 py-1.5 text-on-surface-variant rounded-md text-sm font-bold hover:text-on-surface transition-colors">시급순</button>
                </div>
              </div>
              <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                <button className="px-6 py-2.5 bg-primary text-white rounded-full text-sm font-bold whitespace-nowrap shadow-sm">전체</button>
                <button className="px-6 py-2.5 bg-white border border-[#e0e0e0] text-[#555555] rounded-full text-sm font-bold whitespace-nowrap hover:bg-gray-50 transition-colors">내 주변 5km</button>
                <button className="px-6 py-2.5 bg-white border border-[#e0e0e0] text-[#555555] rounded-full text-sm font-bold whitespace-nowrap hover:bg-gray-50 transition-colors">단기 알바</button>
                <button className="px-6 py-2.5 bg-white border border-[#e0e0e0] text-[#555555] rounded-full text-sm font-bold whitespace-nowrap hover:bg-gray-50 transition-colors">외국인 가능</button>
                <button className="px-6 py-2.5 bg-white border border-[#e0e0e0] text-[#555555] rounded-full text-sm font-bold whitespace-nowrap hover:bg-gray-50 transition-colors">맞춤 필터</button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 px-6 py-6 border-b border-[#e8e8e8] hover:bg-[#f9f9f9] transition-colors items-center">
              <div className="col-span-1 lg:col-span-5">
                <p className="text-[11px] font-bold text-primary mb-0.5">대치동 입시학원</p>
                <h4 className="text-base font-bold flex items-center gap-1.5">
                  <span className="flex items-center gap-1 text-[10px] font-bold text-primary mr-1"><span className="material-symbols-outlined text-[16px]" style={{ fontVariationSettings: '"FILL" 1' }}>notifications_active</span></span>
                  보조 강사 급구 (금일 17시)
                </h4>
              </div>
              <div className="col-span-1 lg:col-span-2 flex items-center text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm mr-1 lg:hidden">location_on</span> 서울 강남구
              </div>
              <div className="col-span-1 lg:col-span-2 flex items-center text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm mr-1 lg:hidden">category</span> 교육/학원
              </div>
              ...
              <div className="col-span-1 lg:col-span-1 flex justify-between lg:justify-end items-center">
                ...
                <button className="material-symbols-outlined text-on-surface-variant/40 hover:text-primary transition-colors lg:hidden">bookmark</button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 px-6 py-6 border-b border-[#e8e8e8] hover:bg-[#f9f9f9] transition-colors items-center">
              ...
              <div className="col-span-1 lg:col-span-2 flex items-center text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm mr-1 lg:hidden">location_on</span> 서울 성동구
              </div>
              <div className="col-span-1 lg:col-span-2 flex items-center text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm mr-1 lg:hidden">category</span> 전시/행사
              </div>
              <div className="col-span-1 lg:col-span-2 text-left lg:text-right">
                <div className="flex lg:flex-col items-center lg:items-end gap-2 lg:gap-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 px-6 py-6 border-b border-[#e8e8e8] hover:bg-[#f9f9f9] transition-colors items-center">
              <div className="col-span-1 lg:col-span-5">
                <p className="text-[11px] font-bold text-primary mb-0.5">압구정 테라스</p>
                <h4 className="text-base font-bold flex items-center gap-1.5">
                  <span className="flex items-center gap-1 text-[10px] font-bold text-primary mr-1"><span className="material-symbols-outlined text-[16px]" style={{ fontVariationSettings: '"FILL" 1' }}>notifications_active</span></span>
                  레스토랑 주방 보조 (내일 고정)
                </h4>
              ...
              <div className="col-span-1 lg:col-span-2 flex items-center text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm mr-1 lg:hidden">category</span> 외식/식음료
              </div>
              <div className="col-span-1 lg:col-span-2 text-left lg:text-right">
                <div className="flex lg:flex-col items-center lg:items-end gap-2 lg:gap-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 px-6 py-6 border-b border-[#e8e8e8] hover:bg-[#f9f9f9] transition-colors items-center">
              ...
              <div className="col-span-1 lg:col-span-2 flex items-center text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm mr-1 lg:hidden">location_on</span> 서울 서초구
              </div>
              <div className="col-span-1 lg:col-span-2 flex items-center text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm mr-1 lg:hidden">category</span> 서비스/기타
              </div>
              <div className="col-span-1 lg:col-span-2 text-left lg:text-right">
                <div className="flex lg:flex-col items-center lg:items-end gap-2 lg:gap-0">
